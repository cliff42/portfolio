    ...
    return (
        <main className="flex justify-center items-center w-full">
            <div className="flex flex-col md:grid md:grid-cols-2 gap-20 justify-center items-center mb-4">
                <div className="card bg-base-100 w-96 shadow-xl border border-gray-300">
                    ...
                    <div className="card-body h-64">
                        ...
                        <div className="card-actions justify-end">
                            <a href="/projects/hsbc-team-vision/" className="btn bg-green-700 text-white hover:bg-green-900">Details</a>
                        </div>
                    </div>
                </div>
                <div className="card bg-base-100 w-96 shadow-xl border border-gray-300">
                    ...
                    <div className="card-body h-64">
                        ...
                        <div className="card-actions justify-end">
                            <a href="/projects/adrift-in-somnium/" className="btn bg-green-700 text-white hover:bg-green-900">Details</a>
                        </div>
                    </div>
                </div>
                <div className="card bg-base-100 w-96 shadow-xl border border-gray-300">
                    ...
                    <div className="card-body h-64">
                        ...
                        <div className="card-actions justify-end">
                            <a href="/projects/natural-event-tracker/" className="btn bg-green-700 text-white hover:bg-green-900">Details</a>
                        </div>
                    </div>
                </div>
                <div className="card bg-base-100 w-96 shadow-xl border border-gray-300">
                    ...
                    <div className="card-body h-64">
                        ...
                        <div className="card-actions justify-end">
                            <a href="/projects/one-giant-leap/" className="btn bg-green-700 text-white hover:bg-green-900">Details</a>
                        </div>
                    </div>
                </div>
                <div className="card bg-base-100 w-96 shadow-xl border border-gray-300">
                    ...
                    <div className="card-body h-64">
                        ...
                        <div className="card-actions justify-end">
                            <a href="/projects/hatewatch/" className="btn bg-green-700 text-white hover:bg-green-900">Details</a>
                        </div>
                    </div>
                </div>
                <div className="card bg-base-100 w-96 shadow-xl border border-gray-300">
                    ...
                    <div className="card-body h-64">
                        ...
                        <div className="card-actions justify-end">
                            <a href="/projects/crowdsource-covid/" className="btn bg-green-700 text-white hover:bg-green-900">Details</a>
                        </div>
                    </div>
                </div>
            </div>
